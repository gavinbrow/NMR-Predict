...
| `run-nmr.bat backend` | Starts only the FastAPI backend on `http://127.0.0.1:8000` |
| `run-nmr.bat frontend` | Starts only the Vite frontend on `http://127.0.0.1:8080` |
| `run-nmr.bat serve` | Builds the frontend and serves both the SPA and the API from FastAPI on `http://127.0.0.1:8000` |
...
- prevents startup when ports `8000` or `8080` are already occupied
